...
<div class="wrapper">
   ...
   <table id="surat" align="center" border="0" cellpadding="1" style="width: 700px;">
         <tbody>
            <tr>
               <td colspan="3">
                  <div align="center">
                     <span style="font-size: x-small;"><b>SMK INFORMATIKA SUMEDANG
                  ...
                  <table border="0" cellpadding="1" style="width: 400px;">
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><span style="font-size: x-small;">:</span></td>
                           <td><span style="font-size: x-small;">Rapat orangtua siswa</span></td>
                        </tr>
                     </tbody>
                  </table>
               </td>
                     ...
                     <table border="0" style="width: 352px;">
                        <tbody>
                           <tr>
                              ...
                              <td width="248"><span style="font-size: x-small;">Rabu, 11 mei 2011</span></td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                              <td><span style="font-size: x-small;">tempat</span></td>
                              <td><span style="font-size: x-small;">:</span></td>
                              <td><span style="font-size: x-small;">Aula SMK Informatika Sumedang </span></td>
                           </tr>
                        </tbody>
                     </table>
                     <div align="justify">
